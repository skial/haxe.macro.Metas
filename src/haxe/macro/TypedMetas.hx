...
**/
@:enum @:forward @:forwardStatics abstract TypedMetas<Arg, Target>(String) from haxe.macro.Metas to String {
	/**
		`@:abi`
		- - -
	...
	**/
	...
	/**
		...
		Applies to: AbstractField
	**/
	public var Impl : haxe.macro.TypedMetas<Void, haxe.macro.Type.ClassField> = haxe.macro.Metas.Impl;
	/**
		`@:pythonImport`
		- - -
	...
	**/
	public var Native : haxe.macro.TypedMetas<haxe.macro.Expr, haxe.macro.Type.BaseType> = haxe.macro.Metas.Native;
	/**
		`@:nativeChildren`
		- - -
	...
	**/
	...
	/**
		...
		For internal compiler use only.
	**/
	public var RequiresAssign : haxe.macro.TypedMetas<Void, haxe.macro.Type.BaseType> = haxe.macro.Metas.RequiresAssign;
	/**
		`@:resolve`
		- - -
